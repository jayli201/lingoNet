    ...
    <div class="content-wrap">
      ...
      <div class="position-relative overflow-hidden p-3 p-md-5 m-md-2">
        <div class="content">
          ...
          <?php $count = 0; ?>
          <?php $displayed_users = array() ?>
          <?php foreach ($user_info_array as $key => $value) : ?>
            <?php $language_info = getMultiLanguageInfo(json_decode($value)->email); ?>
            <?php if (!in_array($language_info, $displayed_users)) : ?>
              <?php array_push($displayed_users, $language_info); ?>
              <?php if ($count % 3 == 0) : ?>
                <div class=" card-deck">
                <?php endif; ?>
                ...
                <div class="card border border-purple">
                  ...
                  <div class="card-body">
                    ...
                    <?php foreach ($language_info['native'] as $native) { ?>
                      <?php echo $native ?>
                      <br />
                    <?php } ?>
                    <br />
                    ...
                    <?php foreach ($language_info['target'] as $target) { ?>
                      <?php echo $target ?>
                      <br />
                    <?php } ?>
                  </div>
