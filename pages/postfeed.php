                ...
                <div class="card-body">
                  <h5 class="card-title">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                      ...
                      <?php if (inFriendtable($_SESSION['email'], json_decode($value)->email)) : ?>
                        <!-- if in friend table and pending, display pending icon -->
                        <?php if (isPendingFriend($_SESSION['email'], json_decode($value)->email, "pending")) : ?>
                          ...
                          <!-- in friend table but not pending, display accepted icon  -->
                        <?php else : ?>
